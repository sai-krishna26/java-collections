...
public class ProductComparableStreamSort {
    public static void main(String[] args) {
        System.out.println("=== Comparable + stream.sorted() ===");
        ...
        // Using Comparable with stream.sorted()
        List<ProductDto> sortedProducts = products.stream()
                .sorted()
                .collect(Collectors.toList());

        System.out.println("\nAfter sorting by productName (Comparable + Stream):");
